...
urlpatterns = [
    ...
    path('user-accepted-list/<pk>/', view_user_accepted_articles_list,
         name='user-accepted-articles'),
     path('view-accepted-article/<pk>/', view_accepted_user_article,
         name='view-accepted-user-articles'),
    path('user-rejected-list/<pk>/', view_user_rejected_articles,
